...
class ExplosionView : UIView {
	...
	func addExplodeAnimation() {
		addExplodeAnimationWithBeginTime(0, fillMode: kCAFillModeBoth, removedOnCompletion: false, nil)
	}

	func addExplodeAnimation(completion: ((Bool) -> Void)?) {
		addExplodeAnimationWithBeginTime(0, fillMode: kCAFillModeBoth, removedOnCompletion: false, completion)
	}

	func addExplodeAnimation(#removedOnCompletion: Bool) {
		addExplodeAnimationWithBeginTime(0, fillMode: removedOnCompletion ? kCAFillModeRemoved : kCAFillModeBoth, removedOnCompletion: removedOnCompletion, nil)
	}

	func addExplodeAnimation(#removedOnCompletion: Bool, completion: ((Bool) -> Void)?) {
		addExplodeAnimationWithBeginTime(0, fillMode: removedOnCompletion ? kCAFillModeRemoved : kCAFillModeBoth, removedOnCompletion: removedOnCompletion, completion)
	}
